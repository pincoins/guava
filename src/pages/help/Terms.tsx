  ...
  return (
    <div className="flex-1 grid grid-cols-1 p-2 sm:p-0 sm:justify-center gap-x-4 gap-y-4">
      <Panel className="grid grid-cols-1 gap-y-2">
        <PanelHeading>
          <h3 className="text-lg font-semibold text-[#1d915c]">이용약관</h3>
        </PanelHeading>
        <Divider />
        <PanelBody className="text-sm leading-7">
          <p>제1조(목적)</p>
          <p>
            이 약관은 핀코인 회사(전자상거래 사업자)가 운영하는 핀코인
            쇼핑몰(이하 "핀코인"이라 한다)에서 제공하는 인터넷 관련 서비스(이하
            "서비스”라 한다)를 이용함에 있어 사이버몰과 이용자의 권리․의무 및
            책임사항을 규정함을 목적으로 합니다.
          </p>
          <p>제2조(정의)</p>
          <p>
            ① "핀코인"이란 핀코인 회사가 재화 또는 용역(이하 "재화 등”이라 함)을
            이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화
            등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러
            사이버몰을 운영하는 사업자의 의미로도 사용합니다.
          </p>
          <p>
            ② "이용자”란 "핀코인"에 접속하여 이 약관에 따라 "핀코인"이 제공하는
            서비스를 받는 회원 및 비회원을 말합니다.
          </p>
          <p>
            ③ '회원’이라 함은 "핀코인"에 회원등록을 한 자로서, 계속적으로
            "핀코인"이 제공하는 서비스를 이용할 수 있는 자를 말합니다.
          </p>
          <p>
            ④ '비회원’이라 함은 회원에 가입하지 않고 "핀코인"이 제공하는
            서비스를 이용하는 자를 말합니다.
          </p>
          <p>제3조 (약관 등의 명시와 설명 및 개정)</p>
          <p>
            ① "핀코인"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지
            주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함),
            전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업
            신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록
            "핀코인"의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은
            이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
          </p>
          <p>
            ② "핀코인"은 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는
            내용 중 청약철회․배송책임․환불조건 등과 같은 중요한 내용을 이용자가
            이해할 수 있도록 별도의 연결화면 또는 팝업화면 등을 제공하여
            이용자의 확인을 구하여야 합니다.
          </p>
          <p>
            ③ "핀코인"은 「전자상거래 등에서의 소비자보호에 관한 법률」,
          ...
          <p>① "핀코인"은 다음과 같은 업무를 수행합니다.</p>
          <p>1. 재화 또는 용역에 대한 정보 제공 및 구매계약의 체결</p>
          <p>2. 구매계약이 체결된 재화 또는 용역의 배송</p>
          <p>3. 기타 "핀코인"이 정하는 업무</p>
          <p>
            ② "핀코인"은 재화 또는 용역의 품절 또는 기술적 사양의 변경 등의
          ...
          <p>
            ③ "핀코인"이 제공하기로 이용자와 계약을 체결한 서비스의 내용을
            재화등의 품절 또는 기술적 사양의 변경 등의 사유로 변경할 경우에는 그
            사유를 이용자에게 통지 가능한 주소로 즉시 통지합니다.
          </p>
          <p>
            ④ 전항의 경우 "핀코인"은 이로 인하여 이용자가 입은 손해를
            배상합니다. 다만, "핀코인"이 고의 또는 과실이 없음을 입증하는
            경우에는 그러하지 아니합니다.
          </p>
          <p>제5조(서비스의 중단)</p>
          <p>
            ① "핀코인"은 컴퓨터 등 정보통신설비의 보수점검․교체 및 고장, 통신의
            두절 등의 사유가 발생한 경우에는 서비스의 제공을 일시적으로 중단할
            수 있습니다.
          </p>
          <p>
            ② "핀코인"은 제1항의 사유로 서비스의 제공이 일시적으로 중단됨으로
            인하여 이용자 또는 제3자가 입은 손해에 대하여 배상합니다. 단,
            "핀코인"이 고의 또는 과실이 없음을 입증하는 경우에는 그러하지
            아니합니다.
          </p>
          <p>
            ③ 사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로 서비스를
            제공할 수 없게 되는 경우에는 "핀코인"은 제8조에 정한 방법으로
            이용자에게 통지하고 당초 "핀코인"에서 제시한 조건에 따라 소비자에게
            보상합니다. 다만, "핀코인"이 보상기준 등을 고지하지 아니한 경우에는
            이용자들의 마일리지 또는 적립금 등을 "핀코인"에서 통용되는
            통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.
          </p>
          <p>제6조(회원가입)</p>
          <p>
            ① 이용자는 "핀코인"이 정한 가입 양식에 따라 회원정보를 기입한 후 이
            약관에 동의한다는 의사표시를 함으로서 회원가입을 신청합니다.
          </p>
          <p>
            ② "핀코인"은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음
            각 호에 해당하지 않는 한 회원으로 등록합니다.
          </p>
          <p>
            1. 가입신청자가 이 약관 제7조제3항에 의하여 이전에 회원자격을 상실한
            적이 있는 경우, 다만 제7조제3항에 의한 회원자격 상실 후 3년이 경과한
            자로서 "핀코인"의 회원재가입 승낙을 얻은 경우에는 예외로 한다.
          </p>
          <p>2. 등록 내용에 허위, 기재누락, 오기가 있는 경우</p>
          <p>
            3. 기타 회원으로 등록하는 것이 "핀코인"의 기술상 현저히 지장이
            있다고 판단되는 경우
          </p>
          <p>
            ③ 회원가입계약의 성립 시기는 "핀코인"의 승낙이 회원에게 도달한
            시점으로 합니다.
          </p>
          <p>
            ④ 회원은 회원가입 시 등록한 사항에 변경이 있는 경우, 상당한 기간
            이내에 "핀코인"에 대하여 회원정보 수정 등의 방법으로 그 변경사항을
            알려야 합니다.
          </p>
          <p>제7조(회원 탈퇴 및 자격 상실 등)</p>
          <p>
            ① 회원은 "핀코인"에 언제든지 탈퇴를 요청할 수 있으며 "핀코인"은 즉시
            회원탈퇴를 처리합니다.
          </p>
          <p>
            ② 회원이 다음 각 호의 사유에 해당하는 경우, "핀코인"은 회원자격을
            제한 및 정지시킬 수 있습니다.
          </p>
          <p>1. 가입 신청 시에 허위 내용을 등록한 경우</p>
          <p>
            2. "핀코인"을 이용하여 구입한 재화 등의 대금, 기타 "핀코인"이용에
            관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우
          </p>
          <p>
            3. 다른 사람의 "핀코인" 이용을 방해하거나 그 정보를 도용하는 등
            전자상거래 질서를 위협하는 경우
          </p>
          <p>
            4. "핀코인"을 이용하여 법령 또는 이 약관이 금지하거나 공서양속에
            반하는 행위를 하는 경우
          </p>
          <p>
            ③ "핀코인"이 회원 자격을 제한․정지 시킨 후, 동일한 행위가 2회 이상
            반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 "핀코인"은
            회원자격을 상실시킬 수 있습니다.
          </p>
          <p>
            ④ "핀코인"이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다.
            이 경우 회원에게 이를 통지하고, 회원등록 말소 전에 최소한 30일
            이상의 기간을 정하여 소명할 기회를 부여합니다.
          </p>
          <p>제8조(회원에 대한 통지)</p>
          <p>
            ① "핀코인"이 회원에 대한 통지를 하는 경우, 회원이 "핀코인"과 미리
            약정하여 지정한 전자우편 주소로 할 수 있습니다.
          </p>
          <p>
            ② "핀코인"은 불특정다수 회원에 대한 통지의 경우 1주일이상 "핀코인"
          ...
          <p>
            ① "핀코인"이용자는 "핀코인"상에서 다음 또는 이와 유사한 방법에
            의하여 구매를 신청하며, "핀코인"은 이용자가 구매신청을 함에 있어서
          ...
          <p>
            5. 재화등의 구매신청 및 이에 관한 확인 또는 "핀코인"의 확인에 대한
            동의
          </p>
          <p>6. 결제방법의 선택</p>
          <p>
            ② "핀코인"이 제3자에게 구매자 개인정보를 제공할 필요가 있는 경우 1)
          ...
          <p>
            ③ "핀코인"이 제3자에게 구매자의 개인정보를 취급할 수 있도록 업무를
          ...
          <p>제10조 (계약의 성립)</p>
          <p>
            ①"핀코인"은 제9조와 같은 구매신청에 대하여 다음 각 호에 해당하면
          ...
          <p>
            3. 기타 구매신청에 승낙하는 것이 "핀코인" 기술상 현저히 지장이
            있다고 판단하는 경우
          </p>
          <p>
            ② "핀코인"의 승낙이 제12조제1항의 수신확인통지형태로 이용자에게
            도달한 시점에 계약이 성립한 것으로 봅니다.
          </p>
          <p>
            ③ "핀코인"의 승낙의 의사표시에는 이용자의 구매 신청에 대한 확인 및
            판매가능 여부, 구매신청의 정정 취소 등에 관한 정보 등을 포함하여야
            합니다.
          </p>
          <p>
            제11조(지급방법) "핀코인"에서 구매한 재화 또는 용역에 대한
            대금지급방법은 다음 각 호의 방법중 가용한 방법으로 할 수 있습니다.
            단, "핀코인"은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한
            명목의 수수료도추가하여 징수할 수 없습니다.
          </p>
          <p>1. 폰뱅킹, 인터넷뱅킹, 메일 뱅킹 등의 각종 계좌이체</p>
          <p>2. 온라인무통장입금</p>
          <p>3. 페이팔 등 기타 전자적 지급 방법에 의한 대금 지급 등</p>
          <p>4. 마일리지 등 "핀코인"이 지급한 포인트에 의한 결제</p>
          <p>제12조(수신확인통지․구매신청 변경 및 취소)</p>
          <p>
            ① "핀코인"은 이용자의 구매신청이 있는 경우 이용자에게 수신확인통지를
            합니다.
          </p>
          <p>
            ② 수신확인통지를 받은 이용자는 의사표시의 불일치 등이 있는 경우에는
            수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있고
            "핀코인"은 배송 전에 이용자의 요청이 있는 경우에는 지체 없이 그
            요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한 경우에는
            제15조의 청약철회 등에 관한 규정에 따릅니다.
          </p>
          <p>제13조(재화 등의 공급)</p>
          <p>
            ① "핀코인"은 이용자와 재화 등의 공급시기에 관하여 별도의 약정이 없는
            이상, 이용자가 청약을 한 날부터 7일 이내에 재화 등을 배송할 수
            있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 다만,
            "핀코인"이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는
            대금의 전부 또는 일부를 받은 날부터 3영업일 이내에 조치를
            취합니다.이때 "핀코인"은 이용자가 재화 등의 공급 절차 및 진행 사항을
            확인할 수 있도록 적절한 조치를 합니다.
          </p>
          <p>
            ② "핀코인"은 이용자가 구매한 재화에 대해 배송수단, 수단별 배송비용
            부담자, 수단별 배송기간 등을 명시합니다. 만약 "핀코인"이 약정
            배송기간을 초과한 경우에는 그로 인한 이용자의 손해를 배상하여야
            합니다. 다만 "핀코인"이 고의․과실이 없음을 입증한 경우에는 그러하지
            아니합니다.
          </p>
          <p>제14조(환급)</p>
          <p>
            ① "핀코인"은 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도
            또는 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게
            통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터
            3영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.
          </p>
          <p>
            ② 휴대폰 결제의 경우, 당월 결제 취소만 가능하며, 익월 이후 취소 요청
            시 청구요금 납부 확인 후 결제자 본인 계좌로만 환불 가능합니다.
          </p>
          <p>제15조(청약철회 등)</p>
          <p>
            ① "핀코인"과 재화등의 구매에 관한 계약을 체결한 이용자는
          ...
          <p>
            ③ 제2항제2호 내지 제4호의 경우에 "핀코인"이 사전에 청약철회 등이
          ...
          <p>제16조(청약철회 등의 효과)</p>
          <p>
            ① "핀코인"은 이용자로부터 재화 등을 반환받은 경우 7영업일 이내에
            이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 "핀코인"이
            이용자에게 재화등의 환급을 지연한때에는 그 지연기간에 대하여
            「전자상거래 등에서의 소비자보호에 관한 법률 시행령」제21조의2에서
            정하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.
          </p>
          <p>
            ② "핀코인"은 위 대금을 환급함에 있어서 이용자가 신용카드 또는
          ...
          <p>
            ⑥ 이용자는 언제든지 "핀코인"이 가지고 있는 자신의 개인정보에 대해
            열람 및 오류정정을 요구할 수 있으며 "핀코인"은 이에 대해 지체 없이
            필요한 조치를 취할 의무를 집니다. 이용자가 오류의 정정을 요구한
            경우에는 "핀코인"은 그 오류를 정정할 때까지 당해 개인정보를 이용하지
            않습니다.
          </p>
          <p>
            ⑦ "핀코인"은 개인정보 보호를 위하여 이용자의 개인정보를 취급하는
            자를최소한으로 제한하여야 하며 신용카드, 은행계좌 등을 포함한
            이용자의 개인정보의 분실, 도난, 유출, 동의 없는 제3자 제공, 변조
            등으로 인한 이용자의 손해에 대하여 모든 책임을 집니다.
          </p>
          <p>
            ⑧ "핀코인" 또는 그로부터 개인정보를 제공받은 제3자는 개인정보의
            수집목적 또는 제공받은 목적을 달성한 때에는 당해 개인정보를 지체
            없이 파기합니다.
          </p>
          <p>
            ⑨ "핀코인"은 개인정보의 수집·이용·제공에 관한 동의 란을 미리 선택한
          ...
          <p>
            ...
            있음을 인지한 경우에는 바로 "핀코인"에 통보하고 "핀코인"의 안내가
            있는 경우에는 그에 따라야 합니다.
          </p>
          <p>제20조(이용자의 의무) 이용자는 다음 행위를 하여서는 안 됩니다.</p>
          <p>1. 신청 또는 변경시 허위 내용의 등록</p>
          <p>2. 타인의 정보 도용</p>
          <p>3. "핀코인"에 게시된 정보의 변경</p>
          <p>
            4. "핀코인"이 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신
            또는 게시
          </p>
          <p>5. "핀코인" 기타 제3자의 저작권 등 지적재산권에 대한 침해</p>
          <p>
            6. "핀코인" 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위
          </p>
          <p>
            7. 외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는
            정보를 "핀코인"에 공개 또는 게시하는 행위
          </p>
          <p>제21조(저작권의 귀속 및 이용제한)</p>
          <p>
            ① "핀코인"이 작성한 저작물에 대한 저작권 기타 지적재산권은
            "핀코인"에 귀속합니다.
          </p>
          <p>
            ② 이용자는 "핀코인"을 이용함으로써 얻은 정보 중 "핀코인"에게
            지적재산권이 귀속된 정보를 "핀코인"의 사전 승낙 없이 복제, 송신,
            출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나
            제3자에게 이용하게 하여서는 안됩니다.
          </p>
          <p>
            ③ "핀코인"은 약정에 따라 이용자에게 귀속된 저작권을 사용하는 경우
            당해 이용자에게 통보하여야 합니다.
          </p>
          <p>제22조(분쟁해결)</p>
          <p>
            ① "핀코인"은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그
            피해를 보상처리하기 위하여 피해보상처리기구를 설치․운영합니다.
          </p>
          ② "핀코인"은 이용자로부터 제출되는 불만사항 및 의견은 우선적으로 그
          사항을 처리합니다. 다만, 신속한 처리가 곤란한 경우에는 이용자에게 그
          사유와 처리일정을 즉시 통보해 드립니다.{' '}
          <p>
            ③ "핀코인"과 이용자 간에 발생한 전자상거래 분쟁과 관련하여 이용자의
            피해구제신청이 있는 경우에는 공정거래위원회 또는 시·도지사가
            의뢰하는 분쟁조정기관의 조정에 따를 수 있습니다.
          </p>
          <p>제23조(재판권 및 준거법)</p>
          <p>
            ① "핀코인"과 이용자 간에 발생한 전자상거래 분쟁에 관한 소송은 제소
          ...
          <p>
            ② "핀코인"과 이용자 간에 제기된 전자상거래 소송에는 한국법을
            적용합니다.
          </p>
        </PanelBody>
      </Panel>
