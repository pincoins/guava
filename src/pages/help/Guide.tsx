  ...
  return (
    <div className="flex-1 grid grid-cols-1 p-2 sm:p-0 sm:justify-center gap-x-4 gap-y-4">
      <Panel divided className="flex-1 grid grid-cols-1 gap-y-2">
        ...
        <PanelBody>
          <ul className="text-sm leading-6 marker:text-[#03353e] list-disc list-inside">
            <li>
            ...
            <li>
              ...
              보관합니다.
              <ul className="marker:text-[#03353e] list-disc list-inside pl-4">
            ...
            <li>
              ...
              <ul className="marker:text-[#03353e] list-disc list-inside pl-4">
                <li>
                  ...
                  <ul className="marker:text-[#03353e] list-disc list-inside pl-8">
                    <li>
      ...
      <Panel divided className="flex-1 grid grid-cols-1 gap-y-2">
        ...
        <PanelBody>
          <ul className="text-sm leading-6 marker:text-[#03353e] list-disc list-inside">
            ...
            <li>
              핀코인 쇼핑몰에서 주문을 완료하시고 다음 은행으로 계좌이체 또는
              무통장 입금 가능합니다.
              <ul className="marker:text-[#03353e] list-disc list-inside pl-4">
                <li>국민은행</li>
                <li>신한은행</li>
